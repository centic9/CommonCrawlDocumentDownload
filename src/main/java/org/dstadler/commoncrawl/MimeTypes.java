...
public class MimeTypes {
    ...
    static {
        ...
        MIME_TYPES.add(Pair.of(Pattern.compile("application/gpx"), ".gpx"));
        MIME_TYPES.add(Pair.of(Pattern.compile("application/gpx\\+xml"), ".gpx"));
        MIME_TYPES.add(Pair.of(Pattern.compile("application/xml-gpx"), ".gpx"));
        MIME_TYPES.add(Pair.of(Pattern.compile("application/x-gpx\\+xml"), ".gpx"));
    }
